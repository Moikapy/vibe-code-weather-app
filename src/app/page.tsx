  ...
  return (
    <main className="min-h-screen bg-[#FAFAFA] dark:bg-[#0A0A0A] p-8 bg-[url('/anime-pattern.png')] bg-opacity-[0.02]">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        {weatherData && (
          <Card className="backdrop-blur-md bg-white/80 dark:bg-black/50 shadow-2xl border-0 relative overflow-hidden">
            <div className="absolute inset-0 bg-[url('/anime-dots.png')] opacity-[0.02]" />
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    {isUsingCurrentLocation && (
                      <span className="ml-2 px-2 py-0.5 text-xs rounded bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-200 font-medium">
                        Current Location
                      </span>
                    )}
                  </div>
